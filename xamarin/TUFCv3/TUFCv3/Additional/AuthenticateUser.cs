...
namespace TUFCv3.Additional
{
    ...
    {
        private IUser databaseUser = new User();     // User details from the database (compared to loginUser to authenticate) 
        ...
        {
            IGetMySqlData getLoginDetails = new GetLoginDetails();        
        ...
        {
            IEncryptionCbcCombo encryption = new EncryptionCbc();                                                      
